...
public class RecruitmentTestService {
	...
	public void addRecrutmentTest(RecruitmentTest test) {
		this.recruitmentTestDAO.saveItem(test);
	}
	
	public void deleteRecruitmentTest(RecruitmentTest test) {
	...
	public void updateRecruitmentTest(RecruitmentTest test) {
		this.recruitmentTestDAO.updateItem(test);
	}
	
	public List<RecruitmentTest> getAllRecruitmentsTests() {
		return this.recruitmentTestDAO.getAllItems();
	}
	
	public RecruitmentTest getRecruitmentTest(String id) {
		return this.recruitmentTestDAO.getItem(id);
	}
	
	public RecruitmentTest getRecruitmentTest(RecruitmentTest test) {
	...
	public void addLanguagesToTest(String testsId, List<String> languagesToAdd) throws DataDuplicatedException, Exception{
		RecruitmentTest test = this.recruitmentTestDAO.getItem(testsId);
		if(test != null) {
		try {
	...
	public boolean deleteLanguageFromTest(String testId, String language) throws Exception {
		RecruitmentTest test = this.recruitmentTestDAO.getItem(testId);
		if(test == null) {
